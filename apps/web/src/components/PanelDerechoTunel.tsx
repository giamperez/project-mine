  ...
  return (
    <div className="panel-tabla panel-derecho" data-oculto={oculto}>
      <div className="tabs-panel-derecho">
        <button
          type="button"
          data-activo={subPestana === "tabla"}
          onClick={() => onCambiarSubPestana("tabla")}
        >
          Taladros ({taladros.length})
        </button>
        <button
          type="button"
          data-activo={subPestana === "voladura"}
          onClick={() => onCambiarSubPestana("voladura")}
          style={{ position: "relative" }}
        >
          Voladura subterránea
          <span style={{ fontSize: 9, marginLeft: 4, background: "#f97316", color: "#000", padding: "1px 5px", borderRadius: 10, fontWeight: 800 }}>
      ...
      {subPestana === "voladura" ? (
        <div style={{ padding: 14, display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <fieldset style={{ margin: 0, padding: "10px 12px" }}>
            <legend style={{ fontSize: 11, fontWeight: 700, color: "#e2e8f0" }}>
              Balance del Disparo (Frente {area_m2.toFixed(1)} m²)
            </legend>
            <div className="resultados" style={{ marginTop: 6 }}>
              <div className="dato">
