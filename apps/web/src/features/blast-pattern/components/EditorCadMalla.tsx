...
export default function EditorCadMalla({
  ...
  function renderContenidoToast(texto: string) {
    let icono = (
    ...
    if (texto.includes("🎯") || texto.toLowerCase().includes("centrad") || texto.toLowerCase().includes("encuadrad")) {
      icono = (
      ...
      textoLimpio = texto.replace(/^[🎯\s]+/, "");
    } else if (texto.includes("✓") || texto.toLowerCase().includes("éxito") || texto.toLowerCase().includes("guardad") || texto.toLowerCase().includes("descargad") || texto.toLowerCase().includes("completad") || texto.toLowerCase().includes("cread") || texto.toLowerCase().includes("aplicad")) {
      icono = (
      ...
      textoLimpio = texto.replace(/^[✓\s]+/, "");
    } else if (texto.includes("🗑️") || texto.toLowerCase().includes("eliminad") || texto.toLowerCase().includes("borrad")) {
      icono = (
        <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2.2">
      ...
      textoLimpio = texto.replace(/^[🗑️\s]+/, "");
    } else if (texto.toLowerCase().includes("error") || texto.toLowerCase().includes("no hay") || texto.toLowerCase().includes("requiere") || texto.toLowerCase().includes("no se") || texto.toLowerCase().includes("selecciona primero")) {
      icono = (
        <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2.2">
          <circle cx="12" cy="12" r="10" />
    ...
    return (
      <div className="cad-toast">
        <span className="cad-toast-icon">{icono}</span>
        <span className="cad-toast-text">{textoLimpio}</span>
      </div>
    );
  }
  ...
  return (
    <div className="cad-screen-wrapper">
      {notificacion && renderContenidoToast(notificacion)}
